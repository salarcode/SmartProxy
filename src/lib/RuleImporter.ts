...
export const RuleImporter = {
	importSwitchyRules(file, append, currentRules, success, fail) {
	...
	importAutoProxy(file, append, currentRules, success, fail) {
		///<summary>
	...
	convertAutoProxyRule(cleanCondition, conditionType) {
		let source = "";
		let pattern = "";
